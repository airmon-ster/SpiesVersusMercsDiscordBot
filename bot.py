    ...
    try:
        ...
        async def mapgen(ctx):
            try:
                ...
                weights = [
                8, # 'Deftech Belew / Extraction',
                2, # 'Deftech Belew / Neutralisation',
                2, # 'Deftech Belew / Sabotage',
                10, # 'Cinema / Neutralisation',
                1, # 'Factory / Extraction',
                2, # 'Factory / Neutralisation',
                1, # 'Factory / Sabotage',
                1, # 'Krauser Lab / Extraction',
                2, # 'Krauser Lab / Neutralisation',
                10, # 'Krauser Lab / Sabotage',
                1, # 'Missile Strike / Extraction',
                2, # 'Missile Strike / Neutralisation',
                1, # 'Missile Strike / Sabotage',
                2, # 'Mount Hospital / Extraction',
                5, # 'Mount Hospital / Neutralisation',
                20, # 'Mount Hospital / Sabotage',
                12, # 'Museum / Neutralisation',
                15, # 'Museum / Sabotage',
                1, # 'Orphanage / Extraction',
                10, # 'Orphanage / Neutralisation',
                20, # 'Orphanage / Sabotage',
                2, # 'Schermerhorn / Extraction',
                5, # 'Schermerhorn / Neutralisation',
                5, # 'Schermerhorn / Sabotage',
                5, # 'Station / Extraction',
                10, # 'Station / Neutralisation',
                20, # 'Station / Sabotage',
                1, # 'Vertigo Plaza / Extraction',
                5, # 'Vertigo Plaza / Neutralisation',
                5, # 'Warehouse / Extraction',
                8, # 'Warehouse / Neutralisation',
                ]
